...
def send(next_process):
    ...
    print("Sending the message from the proccess 3")
    print("Vector Clock before sending the message : ",vector_of_process3)
    vector_of_process3[2] = vector_of_process3[2]+1
    print("Vector Clock after sending the message : ",vector_of_process3)
    ...
    if next_process == 1:
        ...
        Process2_Connection_.receive(vector_of_process3,msg)

    elif next_process == 3:
        Process3_Connection_ = xmlrpc.client.ServerProxy("http://localhost:8816/") #client
        receive(vector_of_process3,msg)
    return "done"
...
print("listening")
print("Initially " ,vector_of_process3)
